...
static int sc2235_get_frame_interval(struct v4l2_subdev *sd,
...
static int sc2235_set_frame_interval(struct v4l2_subdev *sd,
				struct v4l2_subdev_state *sd_state,
				struct v4l2_subdev_frame_interval *fi)
{
	struct sc2235_dev *sensor = to_sc2235_dev(sd);
...
static const struct v4l2_subdev_pad_ops sc2235_pad_ops = {
	...
	.get_frame_interval = sc2235_get_frame_interval,
	.set_frame_interval = sc2235_set_frame_interval,
