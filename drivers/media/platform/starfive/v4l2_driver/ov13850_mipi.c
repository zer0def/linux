...
static int ov13850_get_frame_interval(struct v4l2_subdev *sd,
...
static int ov13850_set_frame_interval(struct v4l2_subdev *sd,
				struct v4l2_subdev_state *sd_state,
				struct v4l2_subdev_frame_interval *fi)
{
	struct ov13850_dev *sensor = to_ov13850_dev(sd);
...
static const struct v4l2_subdev_pad_ops ov13850_pad_ops = {
	...
	.get_frame_interval = ov13850_get_frame_interval,
	.set_frame_interval = ov13850_set_frame_interval,
